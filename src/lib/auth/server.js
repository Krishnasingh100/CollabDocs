...
const baseUrl = process.env.NEON_AUTH_BASE_URL ?? "https://placeholder.neonauth.local/auth";
const cookieSecret =
  process.env.NEON_AUTH_COOKIE_SECRET ?? "placeholder-secret-32-chars-minimum-000000";
