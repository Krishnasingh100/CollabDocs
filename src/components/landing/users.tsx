...
const items = [
  {
    ...
    title: "Individuals",
    detail: "Private personal workspace. Draft, organize, and export your docs.",
  },
  {
    icon: GraduationCap,
    chip: "bg-amber-600/10 text-amber-800 dark:text-amber-200",
    title: "Students",
    detail: "Notes, resumes, and letters from templates — print or export anytime.",
  },
  {
    icon: Briefcase,
    chip: "bg-teal-700/10 text-teal-900 dark:text-teal-200",
    title: "Professionals",
    detail: "Reports and proposals with tables and clean print output.",
  },
];
