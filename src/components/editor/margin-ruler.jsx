...
export function MarginRuler({ left, right, onChange }) {
  ...
  return (
    ...
    >
      {/* margin shading */}
      <div
        className="absolute inset-y-0 left-0 bg-[#f1f3f4]"
        style={{ width: left }}
        aria-hidden="true"
      />
      <div
        className="absolute inset-y-0 right-0 bg-[#f1f3f4]"
        style={{ width: right }}
        aria-hidden="true"
      />
      {/* ticks */}
      ...
      {/* content edge lines */}
      <div
        className="absolute inset-y-0 w-px bg-[#1a73e8]/60"
        style={{ left }}
        aria-hidden="true"
      />
      <div
      ...
      >
        <span
          className="mt-0 block h-0 w-0 border-x-[6px] border-t-[8px] border-x-transparent border-t-[#1a73e8] drop-shadow-sm"
          aria-hidden="true"
        />
      </div>
